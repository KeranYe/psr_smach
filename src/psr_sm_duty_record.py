...
#		self.counter = self.counter + 1.0
        	if not rospy.is_shutdown():
            		...
            		self.vel_msg.linear.x = userdata.LeftDuty * portion * self.counter
            		self.vel_msg.angular.z = userdata.RightDuty * portion * self.counter
...
class SaveData(smach.State):
	...
	self.trial_num = raw_input("Trial Number: ")
	self.filepath = '/home/keran/Documents/PSR_Trial_Data/k_'+self.spring_coeff+'_pos_'+self.mount_pos+'_trial_'+self.trial_num+'.txt'
